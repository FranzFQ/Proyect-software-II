...
export default function ChecklistEjecucion({ checklist, modoEdicion, onGuardar, onCancelar }) {
  ...
  const handleAgregarDocente = (datos) => {
    // Agregar al inicio
    setDocentesObservados(prev => [datos, ...prev]);
    setPaginaDocentes(1);
                ...
                <div className="overflow-hidden rounded-md border border-gray-200">
                  <table className="w-full text-xs">
                    <thead className="bg-gray-50 border-b border-gray-200">
                      <tr>
                        <th className="text-left px-3 py-2 text-gray-500 font-semibold">Docente</th>
                        <th className="text-left px-3 py-2 text-gray-500 font-semibold">Curso</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-100">
                      {docsPagina.map((d, i) => (
                        <tr key={i} className="hover:bg-gray-50 transition-colors">
                          <td className="px-3 py-2 font-semibold text-url-blue truncate max-w-[160px]">
                            {d.docente}
                          </td>
