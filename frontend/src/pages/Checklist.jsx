...
function ChecklistCard({ checklist, onEditar, onEjecutar, onEliminar }) {
  const color = checklist.color || colorDePunteo(checklist.punteo);
  const [menuOpen, setMenuOpen] = useState(false);

  return (
    <div
      className="bg-white rounded-xl p-5 shadow-sm hover:shadow-md transition flex flex-col gap-3 border border-gray-200 border-t-4 cursor-pointer relative"
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-bold text-url-blue text-base">{checklist.titulo}</h3>
