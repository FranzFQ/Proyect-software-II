...
const ProfileSettings = () => {
  ...
  const handleSave = (e) => {
    e.preventDefault();
    if (currentUser) {
      setCurrentUser({ ...currentUser, nombre: nombre });
    }
    ...
    <div className="flex flex-col gap-6 min-h-[calc(100vh-4rem)]">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm max-w-4xl w-full mt-4 mx-auto">
        ...
        <div className="flex items-center gap-6 mb-8">
          <div className="w-24 h-24 bg-url-yellow text-url-blue rounded-full flex items-center justify-center text-4xl font-serif font-bold shadow-inner shrink-0">
        ...
        <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-xs font-bold text-gray-500 uppercase tracking-wide">Correo Institucional (No editable)</label>
            <input 
              type="email" 
