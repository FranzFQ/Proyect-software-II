    ...
    <aside className="w-64 bg-[#112240] text-white min-h-screen flex flex-col shadow-2xl relative z-50">
      ...
      <div className="p-6 flex justify-center items-center h-28 relative mb-2">
        <img
          src={logoUrl}
          alt="Logo URL"
          className="max-h-full max-w-full object-contain brightness-0 invert drop-shadow-md"
        />
        <button
          onClick={onClose}
          className="lg:hidden absolute right-4 text-gray-400 hover:text-white transition-colors"
        >
      ...
      <nav className="flex-1 px-4 py-2 space-y-8 overflow-y-auto">
        ...
        <div>
          <p className="px-4 text-[10px] font-black text-gray-500 uppercase tracking-widest mb-3">
            Menú Principal
          </p>
      ...
      <div className="p-4 mt-auto">
        <div className="relative bg-[#0a1526] rounded-2xl border border-white/5 shadow-lg">
          ...
          {isProfileMenuOpen && (
            <div className="absolute bottom-[calc(100%+0.5rem)] left-0 right-0 bg-white rounded-xl shadow-xl overflow-hidden text-gray-800 border border-gray-200 z-50">
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 text-gray-700 transition-colors font-bold text-sm border-b border-gray-100"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 hover:bg-red-50 text-red-600 transition-colors font-bold text-sm"
              >
          ...
          <button
            ...
            className="w-full flex items-center justify-between p-3 rounded-2xl hover:bg-white/5 transition-colors focus:outline-none"
          >
            ...
            <ChevronUpIcon
              className={`w-5 h-5 text-gray-400 shrink-0 transition-transform duration-300 ${isProfileMenuOpen ? "rotate-180" : ""}`}
            />
          </button>
        </div>
      </div>
